...
| Others || **<div/># UX/UI 디자인 전반** | <div/># Selenium을 이용한 동적 크롤링 구현 <br/> # 카카오맵 api를 이용한 지도 시스템 |<div/># redis를 사용한 이메일 회원 인증 ||
|||||||
...
- 서울 전체 지도 페이지
    ...
    - 친구 목록에서 프로필을 선택하면 그 회원이 가진 맛집 구역들만 표시됩니다.
        - 친구의 프로필을 다시 클릭하면 선택이 해제됩니다. 
...
- 지역구 상세 페이지
    ...
    - 친구 목록에서 프로필을 선택하면 그 회원이 가진 맛집만 표시됩니다.
        - 친구의 프로필을 다시 클릭하면 선택이 해제됩니다. 
        - 하단의 '맛집 추가하기' 버튼을 통해 새로운 맛집을 등록할 수 있습니다.
    - 목록에서 공개된 맛집을 클릭하면 가게 상세정보를 볼 수 있습니다.
        - 카드 우측 하단의 '리뷰 작성' 버튼을 통해 나의 리뷰를 등록할 수 있습니다. 
